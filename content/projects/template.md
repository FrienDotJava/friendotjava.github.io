...
## Overview
This project simulates a real-world manufacturing environment where an AI agent continuously monitors and audits industrial automation logic for security vulnerabilities and logic flaws.

---

## The Problem
I was an intern at a manufacturing company and I observed how the employee work there. I realized that a lot of business process in this company are still manual, which could cause many human error in the process. One of the business process that still manually done is when the Engineering department developed an automation system, they error-hunt manually and could take hours to make sure the system has zero error. This inspired me to develop an AI system that could analyze and find error within industrial automation logic.
